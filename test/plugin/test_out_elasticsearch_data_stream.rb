...
class ElasticsearchOutputDataStreamTest < Test::Unit::TestCase
  ...
  def test_datastream_configure
    ...
    conf = config_element(
      'ROOT', '', {
        ...
        'data_stream_template_do_not_use_wildcard' => true
      })
  ...
  def test_configure_wildcard_usage
    ...
    assert_equal true, driver(config).instance.data_stream_template_do_not_use_wildcard
  end
  ...
  def test_template_index_patterns_without_wildcard
    ...
    conf = config_element(
      ...
      'data_stream_name' => 'foo',
      'data_stream_ilm_name' => 'foo_ilm_policy',
      'data_stream_template_do_not_use_wildcard' => false
    })
